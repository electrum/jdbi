...
public class BatchableObjectHandler extends CustomizingStatementHandler<PreparedBatch> {
    private final SqlBatch sqlBatch;
    private final BatchableObjectHandler.ChunkSizeFunction batchChunkSize;
    private final Function<PreparedBatch, ResultIterator<?>> batchIntermediate;
    private final ResultReturner magic;

    public BatchableObjectHandler(Class<?> sqlObjectType, Method method) {
    ...
    private BatchableObjectHandler.ChunkSizeFunction determineBatchChunkSize(Class<?> sqlObjectType, Method method) {
    ...
    private static class ConstantChunkSizeFunction implements BatchableObjectHandler.ChunkSizeFunction {
    ...
    private static class ParamBasedChunkSizeFunction implements BatchableObjectHandler.ChunkSizeFunction {
